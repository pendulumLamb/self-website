import { aG as vueExports, af as useComponentProps, a9 as useAppConfig, ak as useFieldGroup, ae as useComponentIcons, a6 as tv, a2 as serverRenderer_cjs_prodExports, b as Primitive, f as _sfc_main$n, g as _sfc_main$k } from './server.mjs';
          ...
          if (_push2) {
            ...
            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", { ui: ui.value }, () => {
              if (vueExports.unref(props).label !== void 0 && vueExports.unref(props).label !== null) {
                _push2(`<span data-slot="label" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.label({ class: vueExports.unref(props).ui?.label }))}"${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(props).label)}</span>`);
              } else {
                _push2(`<!---->`);
              }
            }, _push2, _parent2, _scopeId);
            ...
            return [
              ...
              vueExports.renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                vueExports.unref(isTrailing) && vueExports.unref(trailingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                  key: 0,
                  name: vueExports.unref(trailingIconName),
                  "data-slot": "trailingIcon",
                  class: ui.value.trailingIcon({ class: vueExports.unref(props).ui?.trailingIcon })
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/Badge.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Badge-CG2j_j__.mjs.map
