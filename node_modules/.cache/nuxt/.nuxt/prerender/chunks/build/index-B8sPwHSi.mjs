import { aG as vueExports, K as isDef } from './server.mjs';
...
function findSpring({ duration = springDefaults.duration, bounce = springDefaults.bounce, velocity = springDefaults.velocity, mass = springDefaults.mass }) {
  let envelope;
  let derivative;
  warning$1(duration <= /* @__PURE__ */ secondsToMilliseconds(springDefaults.maxDuration), "Spring duration must be 10 seconds or less", "spring-duration-limit");
...
class JSAnimation extends WithPromise {
  ...
  initAnimation() {
    ...
    if (generatorFactory !== keyframes) {
      invariant$1(keyframes$1.length <= 2, `Only two keyframes currently supported with spring and inertia animations. Trying to animate ${keyframes$1}`, "spring-two-frames");
    }
...
export { Motion as M, mountedStates as a, frame as f, motionGlobalConfig as m, provideAnimatePresence as p, useMotionConfig as u };
//# sourceMappingURL=index-B8sPwHSi.mjs.map
