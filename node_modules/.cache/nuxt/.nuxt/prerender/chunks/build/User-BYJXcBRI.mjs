import { aG as vueExports, af as useComponentProps, a9 as useAppConfig, a6 as tv, a2 as serverRenderer_cjs_prodExports, b as Primitive, j as _sfc_main$l, g as _sfc_main$k, h as _sfc_main$i } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.user || {} })({
      size: props.size,
          ...
          if (_push2) {
            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "avatar", { ui: ui.value }, () => {
              if (vueExports.unref(props).chip && vueExports.unref(props).avatar) {
                _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$l, vueExports.mergeProps({ inset: "" }, typeof vueExports.unref(props).chip === "object" ? vueExports.unref(props).chip : {}, {
                  size: vueExports.unref(props).size
                }), {
                  default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$k, vueExports.mergeProps({
                      ...
                      return [
                        vueExports.createVNode(_sfc_main$k, vueExports.mergeProps({
                          alt: vueExports.unref(props).name
                        }, vueExports.unref(props).avatar, {
                          size: vueExports.unref(props).size,
                          "data-slot": "avatar",
            ...
            return [
              vueExports.renderSlot(_ctx.$slots, "avatar", { ui: ui.value }, () => [
                vueExports.unref(props).chip && vueExports.unref(props).avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$l, vueExports.mergeProps({
                  key: 0,
                  inset: ""
                  ...
                  _: 1
                }, 16, ["size"])) : vueExports.unref(props).avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$k, vueExports.mergeProps({
                  key: 1,
                  alt: vueExports.unref(props).name
                }, vueExports.unref(props).avatar, {
                  size: vueExports.unref(props).size,
              ...
              vueExports.createVNode("div", {
                ...
                vueExports.unref(props).to ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$i, vueExports.mergeProps({
                  key: 0,
                  "aria-label": vueExports.unref(props).name
                }, { to: vueExports.unref(props).to, target: vueExports.unref(props).target, ..._ctx.$attrs }, {
                  class: vueExports.unref(prefix)("focus:outline-none peer"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/User.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=User-BYJXcBRI.mjs.map
