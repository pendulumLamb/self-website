import { aG as vueExports, af as useComponentProps, ap as useLocale, ad as useColorMode, a9 as useAppConfig, an as useForwardProps, Y as reactivePick, a6 as tv, $ as refDebounced, a2 as serverRenderer_cjs_prodExports, a4 as transformUI, O as omit, u as createSharedComposable, ag as useDebounceFn, aj as useEventListener, at as usePortal, t as createReusableTemplate, V as VisuallyHidden_default, e as _sfc_main$h, F as FieldGroupReset, a0 as refThrottled, h as _sfc_main$i, S as pickLinkProps, z as get$1, i as _sfc_main$j, f as _sfc_main$n, g as _sfc_main$k, j as _sfc_main$l, a8 as useActiveElement, ai as useEmitAsProps, am as useForwardExpose, P as Presence_default, b as Primitive, ac as useCollection, au as usePrimitiveElement, aC as useVModel, al as useFormField, ak as useFieldGroup, ae as useComponentIcons, Z as refAutoReset, as as useParentElement, B as getActiveElement, p as createContext, a7 as unrefElement, r as createEventHook, a5 as tryOnBeforeUnmount, M as looseToNumber, A as AUTOFOCUS_ON_MOUNT, y as focusFirst, G as getTabbableCandidates, x as focus, a as AUTOFOCUS_ON_UNMOUNT, Q as onKeyStroke, L as isNullish, J as injectConfigProviderContext, E as EVENT_OPTIONS, H as getTabbableEdges, s as createGlobalState } from './server.mjs';
import { defu } from 'file://D:/1PROGRAM/PROJ/portfolio/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { a as DialogRoot_default, b as DialogTrigger_default, D as DialogPortal_default, i as injectDialogRootContext } from './DialogTrigger-k4B8hW2e.mjs';
import { u as useId } from './useId-BKH5UapV.mjs';
import { u as useTypeahead, g as getNextMatch, h as handleAndDispatchCustomEvent, f as findValuesBetween } from './useTypeahead--rguGaRZ.mjs';
import { u as useDirection } from './useDirection-CLi2Qful.mjs';
import { isEqual } from 'file://D:/1PROGRAM/PROJ/portfolio/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { M as MAP_KEY_TO_FOCUS_INTENT, g as getFocusIntent } from './utils-Ba_U-1sR.mjs';
import { u as useKbd$1, _ as _sfc_main$4 } from './Kbd-EUusWzwG.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(Primitive), {
        ...
        onPointerdown: _cache[0] || (_cache[0] = vueExports.withModifiers(() => {
        }, [
          "left",
          "self",
          "prevent"
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(Primitive), {
        ...
        type: "text",
        onKeydown: [vueExports.withKeys(handleKeydownNavigation, [
          "down",
          "up",
          "home",
          "end"
        ]), vueExports.withKeys(handleKeydownEnter, ["enter"])],
        onInput: handleInput,
        onCompositionstart: onCompositionStart,
        onCompositionend: vueExports.unref(handleCompositionEnd)
      }, {
...
var ListboxItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const { forwardRef, currentElement } = useForwardExpose();
    const rootContext = injectListboxRootContext();
    const isHighlighted = vueExports.computed(() => currentElement.value != null && currentElement.value === rootContext.highlightedElement.value);
    ...
    return (_ctx, _cache) => {
      return vueExports.openBlock(), vueExports.createBlock(vueExports.unref(CollectionItem), { value: _ctx.value }, {
        default: vueExports.withCtx(() => [vueExports.withMemo([
          isHighlighted.value,
          isSelected.value,
          disabled.value,
          vueExports.unref(rootContext).focusable.value
        ], () => vueExports.createVNode(vueExports.unref(Primitive), vueExports.mergeProps({ id: vueExports.unref(id) }, _ctx.$attrs, {
          ref: vueExports.unref(forwardRef),
          role: "option",
          ...
          onPointermove: _cache[0] || (_cache[0] = () => {
            ...
            if (vueExports.unref(rootContext).highlightOnHover.value) vueExports.unref(rootContext).changeHighlight(vueExports.unref(currentElement), false, false);
          })
        }), {
          default: vueExports.withCtx(() => [vueExports.renderSlot(_ctx.$slots, "default")]),
          _: 3
...
var ListboxVirtualizer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    const virtualizedItems = vueExports.computed(() => virtualizer.value.getVirtualItems().map((item) => {
      ...
      const targetNode = defaultNode.type === vueExports.Fragment && Array.isArray(defaultNode.children) ? defaultNode.children.find((child) => typeof child.type !== "symbol") : defaultNode;
      return {
        item,
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme$3), ...appConfig.ui?.modal || {} })({
                      ...
                      if (_push4) {
                            ...
                            default: vueExports.withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (!vueExports.unref(props).title && !slots.title) {
                                  _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DialogTitle_default), null, null, _parent5, _scopeId4));
                                ...
                                if (!vueExports.unref(props).description && !slots.description) {
                                  _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DialogDescription_default), null, null, _parent5, _scopeId4));
                                } else if (!!slots.content) {
                        ...
                        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "content", { close }, () => {
                          if (!!slots.header || (vueExports.unref(props).title || !!slots.title) || (vueExports.unref(props).description || !!slots.description) || (vueExports.unref(props).close || !!slots.close)) {
                            _push4(`<div data-slot="header" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.header({ class: vueExports.unref(props).ui?.header }))}"${_scopeId3}>`);
                            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "header", { close }, () => {
                              if (vueExports.unref(props).title || !!slots.title || vueExports.unref(props).description || !!slots.description) {
                                _push4(`<div data-slot="wrapper" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.wrapper({ class: vueExports.unref(props).ui?.wrapper }))}"${_scopeId3}>`);
                                if (vueExports.unref(props).title || !!slots.title) {
                                  _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DialogTitle_default), {
                                    ...
                                    default: vueExports.withCtx((_3, _push5, _parent5, _scopeId4) => {
                                      if (_push5) {
                                        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "title", {}, () => {
                                          _push5(`${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(props).title)}`);
                                ...
                                if (vueExports.unref(props).description || !!slots.description) {
                                  _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DialogDescription_default), {
                                    ...
                                    default: vueExports.withCtx((_3, _push5, _parent5, _scopeId4) => {
                                      if (_push5) {
                                        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "description", {}, () => {
                                          _push5(`${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(props).description)}`);
                                        }, _push5, _parent5, _scopeId4);
                                      } else {
                                        return [
                                          vueExports.renderSlot(_ctx.$slots, "description", {}, () => [
                                    ...
                                    if (_push5) {
                                      serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                                        if (vueExports.unref(props).close) {
                                          _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$h, vueExports.mergeProps({
                                      ...
                                      return [
                                        vueExports.renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          vueExports.unref(props).close ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$h, vueExports.mergeProps({
                                            key: 0,
                                            icon: vueExports.unref(props).closeIcon || vueExports.unref(appConfig).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
                          ...
                          if (!!slots.body) {
                            _push4(`<div data-slot="body" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.body({ class: vueExports.unref(props).ui?.body }))}"${_scopeId3}>`);
                          ...
                          if (!!slots.footer) {
                            _push4(`<div data-slot="footer" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.footer({ class: vueExports.unref(props).ui?.footer }))}"${_scopeId3}>`);
                      ...
                      if (_push4) {
                        if (vueExports.unref(props).scrollable) {
                          _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DialogOverlay_default), {
                            ...
                            default: vueExports.withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ReuseContentTemplate), null, null, _parent5, _scopeId4));
                              } else {
                                return [
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/Modal.vue");
...
function useFuse(search2, data, options) {
  const createFuse = () => {
    ...
    return new entry_default((_toValue = vueExports.toValue(data)) !== null && _toValue !== void 0 ? _toValue : [], (_toValue2 = vueExports.toValue(options)) === null || _toValue2 === void 0 ? void 0 : _toValue2.fuseOptions);
  };
  const fuse = vueExports.shallowRef(createFuse());
  vueExports.watch(() => {
    var _toValue3;
  ...
  return {
    ...
    results: vueExports.computed(() => {
      ...
      if ((resolved === null || resolved === void 0 ? void 0 : resolved.matchAllWhenSearchEmpty) && !vueExports.toValue(search2)) return vueExports.toValue(data).map((item, index) => ({
        item,
        refIndex: index
      }));
      const limit = resolved === null || resolved === void 0 ? void 0 : resolved.resultLimit;
      return fuse.value.search(vueExports.toValue(search2), limit ? { limit } : void 0);
    })
  };
}
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const appConfig = useAppConfig();
    const { emitFormBlur, emitFormInput, emitFormChange, size: formFieldSize, color, id, name, highlight: highlight2, disabled, emitFormFocus, ariaAttrs } = useFormField(_props, {});
    const { orientation, size: fieldGroupSize } = useFieldGroup(_props);
    const { isLeading, isTrailing, leadingIconName, trailingIconName } = useComponentIcons(props);
    const inputSize = vueExports.computed(() => fieldGroupSize.value || formFieldSize.value);
    const ui = vueExports.computed(() => tv({ extend: tv(theme$2), ...appConfig.ui?.input || {} })({
      type: props.type,
      color: color.value ?? props.color,
      variant: props.variant,
      size: inputSize?.value ?? props.size,
      loading: props.loading,
      highlight: highlight2.value ?? props.highlight,
      fixed: props.fixed,
            ...
            if (vueExports.unref(isLeading) || !!vueExports.unref(props).avatar || !!slots.leading) {
              ...
              serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
                if (vueExports.unref(isLeading) && vueExports.unref(leadingIconName)) {
                  ...
                  _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$k, vueExports.mergeProps({
            ...
            return [
              ...
              vueExports.unref(isLeading) || !!vueExports.unref(props).avatar || !!slots.leading ? (vueExports.openBlock(), vueExports.createBlock("span", {
                ...
                vueExports.renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                  vueExports.unref(isLeading) && vueExports.unref(leadingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                    key: 0,
                    name: vueExports.unref(leadingIconName),
                    "data-slot": "leadingIcon",
                    class: ui.value.leadingIcon({ class: vueExports.unref(props).ui?.leadingIcon })
                  }, null, 8, ["name", "class"])) : !!vueExports.unref(props).avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$k, vueExports.mergeProps({
                    key: 1,
                    size: vueExports.unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                  }, vueExports.unref(props).avatar, {
                    "data-slot": "leadingAvatar",
              ...
              vueExports.unref(isTrailing) || !!slots.trailing ? (vueExports.openBlock(), vueExports.createBlock("span", {
                ...
                vueExports.renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                  vueExports.unref(trailingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                    key: 0,
                    name: vueExports.unref(trailingIconName),
                    "data-slot": "trailingIcon",
                    class: ui.value.trailingIcon({ class: vueExports.unref(props).ui?.trailingIcon })
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
...
const _sfc_main$1 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    vueExports.watch(filteredGroups, () => {
      vueExports.nextTick(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(DefineItemTemplate), null, {
        default: vueExports.withCtx(({ item, index, group }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$i, vueExports.mergeProps(vueExports.unref(pickLinkProps)(item), { custom: "" }), {
              default: vueExports.withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxItem_default), {
                    value: vueExports.unref(props).valueKey ? vueExports.unref(get$1)(item, vueExports.unref(props).valueKey) : vueExports.unref(omit)(item, ["matches", "group", "onSelect", "labelHtml", "suffixHtml", "descriptionHtml", "children"]),
                    ...
                    default: vueExports.withCtx((_, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$j, vueExports.mergeProps(slotProps, {
                          "data-slot": "item",
                          class: ui.value.item({ class: [vueExports.unref(props).ui?.item, item.ui?.item, item.class], active: active || item.active })
                        }), {
                          default: vueExports.withCtx((_2, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                item,
                                index,
                                ui: ui.value
                              }, () => {
                                serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                  item,
                                  index,
                                  ui: ui.value
                                }, () => {
                                  if (item.loading) {
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$n, {
                                      name: vueExports.unref(props).loadingIcon || vueExports.unref(appConfig).ui.icons.loading,
                                      "data-slot": "itemLeadingIcon",
                                      class: ui.value.itemLeadingIcon({ class: [vueExports.unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], loading: true })
                                    }, null, _parent5, _scopeId4));
                                  } else if (item.icon) {
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$n, {
                                      name: item.icon,
                                      "data-slot": "itemLeadingIcon",
                                      class: ui.value.itemLeadingIcon({ class: [vueExports.unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], active: active || item.active })
                                    }, null, _parent5, _scopeId4));
                                  } else if (item.avatar) {
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$k, vueExports.mergeProps({
                                      size: item.ui?.itemLeadingAvatarSize || vueExports.unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize()
                                    }, item.avatar, {
                                      "data-slot": "itemLeadingAvatar",
                                      class: ui.value.itemLeadingAvatar({ class: [vueExports.unref(props).ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                    }), null, _parent5, _scopeId4));
                                  } else if (item.chip) {
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$l, vueExports.mergeProps({
                                      size: item.ui?.itemLeadingChipSize || vueExports.unref(props).ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                      inset: "",
                                      standalone: ""
                                    }, item.chip, {
                                      "data-slot": "itemLeadingChip",
                                      class: ui.value.itemLeadingChip({ class: [vueExports.unref(props).ui?.itemLeadingChip, item.ui?.itemLeadingChip], active: active || item.active })
                                    }), null, _parent5, _scopeId4));
                                  } else {
                                    _push5(`<!---->`);
                                  }
                                }, _push5, _parent5, _scopeId4);
                                if (item.prefix || (item.labelHtml || vueExports.unref(get$1)(item, vueExports.unref(props).labelKey)) || (item.suffixHtml || item.suffix) || !!slots[item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`] || (vueExports.unref(get$1)(item, vueExports.unref(props).descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`])) {
                                  _push5(`<span data-slot="itemWrapper" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemWrapper({ class: [vueExports.unref(props).ui?.itemWrapper, item.ui?.itemWrapper] }))}"${_scopeId4}><span data-slot="itemLabel" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabel({ class: [vueExports.unref(props).ui?.itemLabel, item.ui?.itemLabel], active: active || item.active }))}"${_scopeId4}>`);
                                  serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`, {
                                    item,
                                    index,
                                    ui: ui.value
                                  }, () => {
                                    if (item.prefix) {
                                      _push5(`<span data-slot="itemLabelPrefix" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabelPrefix({ class: [vueExports.unref(props).ui?.itemLabelPrefix, item.ui?.itemLabelPrefix] }))}"${_scopeId4}>${serverRenderer_cjs_prodExports.ssrInterpolate(item.prefix)}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    if (item.labelHtml) {
                                      _push5(`<span data-slot="itemLabelBase" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabelBase({ class: [vueExports.unref(props).ui?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active }))}"${_scopeId4}>${item.labelHtml ?? ""}</span>`);
                                    } else {
                                      _push5(`<span data-slot="itemLabelBase" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabelBase({ class: [vueExports.unref(props).ui?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active }))}"${_scopeId4}>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(get$1)(item, vueExports.unref(props).labelKey))}</span>`);
                                    }
                                    if (item.suffixHtml) {
                                      _push5(`<span data-slot="itemLabelSuffix" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabelSuffix({ class: [vueExports.unref(props).ui?.itemLabelSuffix, item.ui?.itemLabelSuffix], active: active || item.active }))}"${_scopeId4}>${item.suffixHtml ?? ""}</span>`);
                                    } else if (item.suffix) {
                                      _push5(`<span data-slot="itemLabelSuffix" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemLabelSuffix({ class: [vueExports.unref(props).ui?.itemLabelSuffix, item.ui?.itemLabelSuffix], active: active || item.active }))}"${_scopeId4}>${serverRenderer_cjs_prodExports.ssrInterpolate(item.suffix)}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                  }, _push5, _parent5, _scopeId4);
                                  ...
                                  if (item.descriptionHtml) {
                                    _push5(`<span data-slot="itemDescription" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemDescription({ class: [vueExports.unref(props).ui?.itemDescription, item.ui?.itemDescription] }))}"${_scopeId4}>${item.descriptionHtml ?? ""}</span>`);
                                  } else if (vueExports.unref(get$1)(item, vueExports.unref(props).descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`]) {
                                    _push5(`<span data-slot="itemDescription" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemDescription({ class: [vueExports.unref(props).ui?.itemDescription, item.ui?.itemDescription] }))}"${_scopeId4}>`);
                                    serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`, {
                                      item,
                                      index,
                                      ui: ui.value
                                    }, () => {
                                      _push5(`${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(get$1)(item, vueExports.unref(props).descriptionKey))}`);
                                    }, _push5, _parent5, _scopeId4);
                                    _push5(`</span>`);
                                  } else {
                                    _push5(`<!---->`);
                                ...
                                _push5(`<span data-slot="itemTrailing" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemTrailing({ class: [vueExports.unref(props).ui?.itemTrailing, item.ui?.itemTrailing] }))}"${_scopeId4}>`);
                                serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group?.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                  item,
                                  index,
                                  ui: ui.value
                                }, () => {
                                  if (item.children && item.children.length > 0) {
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$n, {
                                      name: vueExports.unref(props).childrenIcon || vueExports.unref(appConfig).ui.icons.chevronRight,
                                      "data-slot": "itemTrailingIcon",
                                      class: ui.value.itemTrailingIcon({ class: [vueExports.unref(props).ui?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                    }, null, _parent5, _scopeId4));
                                  } else if (item.kbds?.length) {
                                    _push5(`<span data-slot="itemTrailingKbds" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.itemTrailingKbds({ class: [vueExports.unref(props).ui?.itemTrailingKbds, item.ui?.itemTrailingKbds] }))}"${_scopeId4}><!--[-->`);
                                    serverRenderer_cjs_prodExports.ssrRenderList(item.kbds, (kbd, kbdIndex) => {
                                      _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$4, vueExports.mergeProps({
                                        key: kbdIndex,
                                        size: item.ui?.itemTrailingKbdsSize || vueExports.unref(props).ui?.itemTrailingKbdsSize || ui.value.itemTrailingKbdsSize()
                                    ...
                                    _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$n, {
                                      ...
                                      class: ui.value.itemTrailingHighlightedIcon({ class: [vueExports.unref(props).ui?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
                                    }, null, _parent5, _scopeId4));
                                  } else {
                                    _push5(`<!---->`);
                                  }
                                ...
                                if (!item.children?.length) {
                                  _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxItemIndicator_default), { "as-child": "" }, {
                                    default: vueExports.withCtx((_3, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$n, {
                              ...
                              return [
                                vueExports.renderSlot(_ctx.$slots, item.slot || group?.slot || "item", {
                                  ...
                                  vueExports.renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group?.slot ? `${group.slot}-leading` : `item-leading`, {
                                    ...
                                    item.loading ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                                      key: 0,
                                      name: vueExports.unref(props).loadingIcon || vueExports.unref(appConfig).ui.icons.loading,
                                      "data-slot": "itemLeadingIcon",
                                      class: ui.value.itemLeadingIcon({ class: [vueExports.unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], loading: true })
                                    }, null, 8, ["name", "class"])) : item.icon ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                                      key: 1,
                                      name: item.icon,
                                      "data-slot": "itemLeadingIcon",
                                      class: ui.value.itemLeadingIcon({ class: [vueExports.unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon], active: active || item.active })
                                    }, null, 8, ["name", "class"])) : item.avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$k, vueExports.mergeProps({
                                      key: 2,
                                      size: item.ui?.itemLeadingAvatarSize || vueExports.unref(props).ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize()
                                    }, item.avatar, {
                                      "data-slot": "itemLeadingAvatar",
                                      class: ui.value.itemLeadingAvatar({ class: [vueExports.unref(props).ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                    }), null, 16, ["size", "class"])) : item.chip ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$l, vueExports.mergeProps({
                                      key: 3,
                                      size: item.ui?.itemLeadingChipSize || vueExports.unref(props).ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                      inset: "",
                                      standalone: ""
                                  ...
                                  item.prefix || (item.labelHtml || vueExports.unref(get$1)(item, vueExports.unref(props).labelKey)) || (item.suffixHtml || item.suffix) || !!slots[item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`] || (vueExports.unref(get$1)(item, vueExports.unref(props).descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`]) ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                    key: 0,
                                    "data-slot": "itemWrapper",
                                    class: ui.value.itemWrapper({ class: [vueExports.unref(props).ui?.itemWrapper, item.ui?.itemWrapper] })
                                  }, [
                                    vueExports.createVNode("span", {
                                      "data-slot": "itemLabel",
                                      class: ui.value.itemLabel({ class: [vueExports.unref(props).ui?.itemLabel, item.ui?.itemLabel], active: active || item.active })
                                    }, [
                                      vueExports.renderSlot(_ctx.$slots, item.slot ? `${item.slot}-label` : group?.slot ? `${group.slot}-label` : `item-label`, {
                                        ...
                                        item.prefix ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                          ...
                                          class: ui.value.itemLabelPrefix({ class: [vueExports.unref(props).ui?.itemLabelPrefix, item.ui?.itemLabelPrefix] })
                                        ...
                                        item.labelHtml ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                          ...
                                          class: ui.value.itemLabelBase({ class: [vueExports.unref(props).ui?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active }),
                                          innerHTML: item.labelHtml
                                        }, null, 10, ["innerHTML"])) : (vueExports.openBlock(), vueExports.createBlock("span", {
                                          key: 2,
                                          "data-slot": "itemLabelBase",
                                          class: ui.value.itemLabelBase({ class: [vueExports.unref(props).ui?.itemLabelBase, item.ui?.itemLabelBase], active: active || item.active })
                                        }, vueExports.toDisplayString(vueExports.unref(get$1)(item, vueExports.unref(props).labelKey)), 3)),
                                        item.suffixHtml ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                          key: 3,
                                          "data-slot": "itemLabelSuffix",
                                          class: ui.value.itemLabelSuffix({ class: [vueExports.unref(props).ui?.itemLabelSuffix, item.ui?.itemLabelSuffix], active: active || item.active }),
                                    ...
                                    item.descriptionHtml ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                      key: 0,
                                      "data-slot": "itemDescription",
                                      class: ui.value.itemDescription({ class: [vueExports.unref(props).ui?.itemDescription, item.ui?.itemDescription] }),
                                      innerHTML: item.descriptionHtml
                                    }, null, 10, ["innerHTML"])) : vueExports.unref(get$1)(item, vueExports.unref(props).descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : group?.slot ? `${group.slot}-description` : `item-description`] ? (vueExports.openBlock(), vueExports.createBlock("span", {
                                      key: 1,
                                      "data-slot": "itemDescription",
                                      class: ui.value.itemDescription({ class: [vueExports.unref(props).ui?.itemDescription, item.ui?.itemDescription] })
                                    }, [
                                  ...
                                  vueExports.createVNode("span", {
                                    ...
                                    class: ui.value.itemTrailing({ class: [vueExports.unref(props).ui?.itemTrailing, item.ui?.itemTrailing] })
                                  }, [
                                    vueExports.renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group?.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                      ...
                                      item.children && item.children.length > 0 ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                                        key: 0,
                                        name: vueExports.unref(props).childrenIcon || vueExports.unref(appConfig).ui.icons.chevronRight,
                                        "data-slot": "itemTrailingIcon",
                                        class: ui.value.itemTrailingIcon({ class: [vueExports.unref(props).ui?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                        ...
                                        class: ui.value.itemTrailingKbds({ class: [vueExports.unref(props).ui?.itemTrailingKbds, item.ui?.itemTrailingKbds] })
                                      }, [
                                      ...
                                      ], 2)) : group?.highlightedIcon ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$n, {
                                        key: 2,
                                        name: group.highlightedIcon,
                                        "data-slot": "itemTrailingHighlightedIcon",
                                        class: ui.value.itemTrailingHighlightedIcon({ class: [vueExports.unref(props).ui?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
                        ...
                        return [
                          vueExports.createVNode(_sfc_main$j, vueExports.mergeProps(slotProps, {
                            "data-slot": "item",
                            class: ui.value.item({ class: [vueExports.unref(props).ui?.item, item.ui?.item, item.class], active: active || item.active })
                          }), {
                            default: vueExports.withCtx(() => [
            ...
            return [
              vueExports.createVNode(_sfc_main$i, vueExports.mergeProps(vueExports.unref(pickLinkProps)(item), { custom: "" }), {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxRoot_default), vueExports.mergeProps({ ...vueExports.unref(rootProps), ..._ctx.$attrs }, {
        ref_key: "rootRef",
        ref: rootRef,
        "selection-behavior": vueExports.unref(props).selectionBehavior,
        "data-slot": "root",
        class: ui.value.root({ class: [vueExports.unref(props).ui?.root, vueExports.unref(props).class] })
      }), {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (vueExports.unref(props).input) {
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxFilter_default), {
                ...
                default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$2, vueExports.mergeProps({
                      variant: "none",
                      size: vueExports.unref(props).size
                    }, typeof vueExports.unref(props).input === "object" ? vueExports.unref(props).input : {}, {
                      placeholder: placeholder.value,
                      autofocus: vueExports.unref(props).autofocus,
                      loading: vueExports.unref(props).loading,
                      "loading-icon": vueExports.unref(props).loadingIcon,
                      "trailing-icon": vueExports.unref(props).trailingIcon,
                      icon: vueExports.unref(props).icon || vueExports.unref(appConfig).ui.icons.search,
                      "data-slot": "input",
                      class: ui.value.input({ class: vueExports.unref(props).ui?.input }),
                      onKeydown: onBackspace
                    }), vueExports.createSlots({ _: 2 }, [
                      history.value?.length && (vueExports.unref(props).back || !!slots.back) ? {
                        name: "leading",
                        fn: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "back", { ui: ui.value }, () => {
                              _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$h, vueExports.mergeProps({
                                size: vueExports.unref(props).size,
                                icon: vueExports.unref(props).backIcon || vueExports.unref(appConfig).ui.icons.arrowLeft,
                                color: "neutral",
                                variant: "link",
                                "aria-label": vueExports.unref(t)("commandPalette.back")
                              }, typeof vueExports.unref(props).back === "object" ? vueExports.unref(props).back : {}, {
                                "data-slot": "back",
                                class: ui.value.back({ class: vueExports.unref(props).ui?.back }),
                            ...
                            return [
                              vueExports.renderSlot(_ctx.$slots, "back", { ui: ui.value }, () => [
                                vueExports.createVNode(_sfc_main$h, vueExports.mergeProps({
                                  size: vueExports.unref(props).size,
                                  icon: vueExports.unref(props).backIcon || vueExports.unref(appConfig).ui.icons.arrowLeft,
                                  color: "neutral",
                                  variant: "link",
                      ...
                      vueExports.unref(props).close || !!slots.close ? {
                        name: "trailing",
                        fn: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxContent_default), {
              "data-slot": "content",
              ...
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (filteredGroups.value?.length) {
                    _push3(`<div role="presentation" data-slot="viewport" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.viewport({ class: vueExports.unref(props).ui?.viewport }))}"${_scopeId2}>`);
                    if (!!vueExports.unref(props).virtualize) {
                      _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxVirtualizer_default), vueExports.mergeProps({
                        options: filteredItems.value,
                        "text-content": (item2) => vueExports.unref(get$1)(item2, vueExports.unref(props).labelKey)
                      }, virtualizerProps.value), {
                        default: vueExports.withCtx(({ option: item, virtualItem }, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ReuseItemTemplate), {
                              item,
                      ...
                      _push3(`<!--[-->`);
                      serverRenderer_cjs_prodExports.ssrRenderList(filteredGroups.value, (group) => {
                        _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxGroup_default), {
                          key: `group-${group.id}`,
                          "data-slot": "group",
                          ...
                          default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              if (vueExports.unref(get$1)(group, vueExports.unref(props).labelKey) || !!slots[group.slot ? `${group.slot}-group-label` : "group-label"]) {
                                _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ListboxGroupLabel_default), {
                                  "data-slot": "label",
                                  class: ui.value.label({ class: vueExports.unref(props).ui?.label })
                                }, {
                                  default: vueExports.withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, group.slot ? `${group.slot}-group-label` : "group-label", {
                                        group,
                                        label: vueExports.unref(get$1)(group, vueExports.unref(props).labelKey),
                                        ui: ui.value
                                      }, () => {
                                        _push5(`${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(get$1)(group, vueExports.unref(props).labelKey))}`);
                                      }, _push5, _parent5, _scopeId4);
                                    } else {
                                      return [
                                        vueExports.renderSlot(_ctx.$slots, group.slot ? `${group.slot}-group-label` : "group-label", {
                                          group,
                                          label: vueExports.unref(get$1)(group, vueExports.unref(props).labelKey),
                                          ui: ui.value
                                        }, () => [
                                          vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(get$1)(group, vueExports.unref(props).labelKey)), 1)
                                        ])
                                      ];
                                    }
                                  }),
                              ...
                              _push4(`<!--[-->`);
                              serverRenderer_cjs_prodExports.ssrRenderList(group.items, (item, index) => {
                                _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(ReuseItemTemplate), {
                              ...
                              return [
                                vueExports.unref(get$1)(group, vueExports.unref(props).labelKey) || !!slots[group.slot ? `${group.slot}-group-label` : "group-label"] ? (vueExports.openBlock(), vueExports.createBlock(vueExports.unref(ListboxGroupLabel_default), {
                                  key: 0,
                                  "data-slot": "label",
                                  class: ui.value.label({ class: vueExports.unref(props).ui?.label })
                                }, {
                    ...
                    _push3(`<div data-slot="empty" class="${serverRenderer_cjs_prodExports.ssrRenderClass(ui.value.empty({ class: vueExports.unref(props).ui?.empty }))}"${_scopeId2}>`);
                    serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "empty", { searchTerm: searchTerm.value }, () => {
                      _push3(`${serverRenderer_cjs_prodExports.ssrInterpolate(searchTerm.value ? vueExports.unref(t)("commandPalette.noMatch", { searchTerm: searchTerm.value }) : vueExports.unref(t)("commandPalette.noData"))}`);
                  ...
                  return [
                    filteredGroups.value?.length ? (vueExports.openBlock(), vueExports.createBlock("div", {
                      ...
                      !!vueExports.unref(props).virtualize ? (vueExports.openBlock(), vueExports.createBlock(vueExports.unref(ListboxVirtualizer_default), vueExports.mergeProps({
                        key: 0,
                        options: filteredItems.value,
                        "text-content": (item2) => vueExports.unref(get$1)(item2, vueExports.unref(props).labelKey)
                      }, virtualizerProps.value), {
                      ...
                      key: 1,
                      "data-slot": "empty",
                      class: ui.value.empty({ class: vueExports.unref(props).ui?.empty })
                    }, [
            ...
            if (!!slots.footer) {
              ...
              serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "footer", { ui: ui.value }, null, _push2, _parent2, _scopeId);
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              vueExports.unref(props).input ? (vueExports.openBlock(), vueExports.createBlock(vueExports.unref(ListboxFilter_default), {
                key: 0,
                modelValue: searchTerm.value,
                "onUpdate:modelValue": ($event) => searchTerm.value = $event,
                "as-child": ""
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/CommandPalette.vue");
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.contentSearch || {} })({
      size: props.size,
      fullscreen: props.fullscreen
    }));
    ...
    const rawSearchResults = vueExports.shallowRef([]);
    const searchResults = vueExports.computed(() => mapSearchResults(rawSearchResults.value, props.navigation));
    ...
    vueExports.watch(debouncedSearchTerm, runSearch);
    vueExports.watch(() => props.search, () => {
      if (debouncedSearchTerm.value) {
        runSearch(debouncedSearchTerm.value);
      }
    });
    vueExports.watch(() => props.searchStatus, (status) => {
      if (status === "ready" && debouncedSearchTerm.value) {
        runSearch(debouncedSearchTerm.value);
      }
    });
    const linksGroup = vueExports.computed(() => {
    ...
    const navigationGroups = vueExports.computed(() => {
    ...
    const themeGroup = vueExports.computed(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$3, vueExports.mergeProps({
        ...
        title: vueExports.unref(props).title || vueExports.unref(t)("contentSearch.title"),
        description: vueExports.unref(props).description || vueExports.unref(t)("contentSearch.description")
      }, vueExports.unref(modalProps), {
        "data-slot": "modal",
        class: ui.value.modal({ class: [vueExports.unref(props).ui?.modal, vueExports.unref(props).class] })
      }, _attrs), {
        content: vueExports.withCtx((contentData, _push2, _parent2, _scopeId) => {
          if (_push2) {
            serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "content", contentData, () => {
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$1, vueExports.mergeProps({
                ...
                fuse: fuse.value,
                input: { fixed: true },
                ui: vueExports.unref(transformUI)(vueExports.unref(omit)(ui.value, ["modal"]), vueExports.unref(props).ui),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/content/ContentSearch.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentSearch-DfI4cOpe.mjs.map
