import { aG as vueExports, af as useComponentProps, a9 as useAppConfig, a6 as tv, n as avatarGroupInjectionKey, a2 as serverRenderer_cjs_prodExports, b as Primitive, g as _sfc_main$4, ap as useLocale, D as getSlotChildrenText, I as ImageComponent, h as _sfc_main$5, O as omit, aa as useAsyncData, U as queryCollection, q as createError, aA as useSeoMeta, m as _sfc_main$8 } from "../server.mjs";
import { _ as _sfc_main$9, a as _sfc_main$a } from "./PageSection-BKV9dIS9.js";
import { u as usePrefix } from "./usePrefix-Bs-2N9Zn.js";
import { _ as _sfc_main$6 } from "./Badge-CG2j_j__.js";
import { _ as _sfc_main$7 } from "./User-BYJXcBRI.js";
...
function useDateFormatter(initialLocale, opts = {}) {
  const locale = vueExports.ref(initialLocale);
  function getLocale() {
    return locale.value;
  }
  ...
  function dayPeriod(date) {
    const parts = new $12a3c853105e5a70$export$ad991b66133851cf(locale.value, {
      ...opts,
      hour: "numeric",
      minute: "numeric"
    }).formatToParts(date);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme$2), ...appConfig.ui?.avatarGroup || {} })({
      size: props.size,
      color: props.color
    }));
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(Primitive), vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              hiddenCount.value > 0 ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$4, {
                key: 0,
                text: `+${hiddenCount.value}`,
                "data-slot": "base",
                class: ui.value.base({ class: vueExports.unref(props).ui?.base })
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/AvatarGroup.vue");
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = vueExports.computed(() => tv({ extend: tv(theme$1), ...appConfig.ui?.blogPost || {} })({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (vueExports.unref(props).to) {
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$5, vueExports.mergeProps({ "aria-label": ariaLabel.value }, { to: vueExports.unref(props).to, target: vueExports.unref(props).target, ..._ctx.$attrs }, {
                ...
                serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => {
                  if (vueExports.unref(props).authors?.length) {
                    ...
                    if (vueExports.unref(props).authors.length > 1) {
                          ...
                          if (_push3) {
                            ...
                            serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(props).authors, (author, index) => {
                              _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$5, {
                                ...
                                default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                                  if (_push4) {
                                    _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$4, vueExports.mergeProps({ ref_for: true }, author.avatar), null, _parent4, _scopeId3));
                                  } else {
                                    return [
                                      vueExports.createVNode(_sfc_main$4, vueExports.mergeProps({ ref_for: true }, author.avatar), null, 16)
                                    ];
                                  }
                                }),
                                _: 2
                            ...
                            return [
                              (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(props).authors, (author, index) => {
                                return vueExports.openBlock(), vueExports.createBlock(_sfc_main$5, {
                                  key: index,
                                  to: author.to,
                                  target: author.target,
                                  "data-slot": "avatar",
                      ...
                      _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.unref(props).authors[0], null, _parent2, _scopeId));
                    }
                    _push2(`<!--]-->`);
                  } else {
                    _push2(`<!---->`);
            ...
            return [
              ...
              vueExports.createVNode("div", {
                ...
                vueExports.unref(props).to ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$5, vueExports.mergeProps({
                  key: 0,
                ...
                vueExports.renderSlot(_ctx.$slots, "body", {}, () => [
                  date.value || !!slots.date || (vueExports.unref(props).badge || !!slots.badge) ? (vueExports.openBlock(), vueExports.createBlock("div", {
                    ...
                    vueExports.renderSlot(_ctx.$slots, "badge", {}, () => [
                      vueExports.unref(props).badge ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$6, vueExports.mergeProps({
                        key: 0,
                        color: "neutral",
                        variant: "subtle"
                      }, typeof vueExports.unref(props).badge === "string" ? { label: vueExports.unref(props).badge } : vueExports.unref(props).badge, {
                  ...
                  vueExports.unref(props).authors?.length || !!slots.authors ? (vueExports.openBlock(), vueExports.createBlock("div", {
                    ...
                    vueExports.renderSlot(_ctx.$slots, "authors", { ui: ui.value }, () => [
                      vueExports.unref(props).authors?.length ? (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: 0 }, [
                        vueExports.unref(props).authors.length > 1 ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$3, { key: 0 }, {
                          default: vueExports.withCtx(() => [
                            (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(props).authors, (author, index) => {
                              return vueExports.openBlock(), vueExports.createBlock(_sfc_main$5, {
                                key: index,
                          ...
                          _: 1
                        })) : (vueExports.openBlock(), vueExports.createBlock(_sfc_main$7, vueExports.mergeProps({ key: 1 }, vueExports.unref(props).authors[0]), null, 16))
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/BlogPost.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const appConfig = useAppConfig();
    const ui = vueExports.computed(() => tv({ extend: tv(theme), ...appConfig.ui?.blogPosts || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(Primitive), vueExports.mergeProps({
        as: vueExports.unref(props).as,
        "data-orientation": vueExports.unref(props).orientation,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/BlogPosts.vue");
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: page } = ([__temp, __restore] = vueExports.withAsyncContext(() => useAsyncData("blog-page", () => {
    ...
    const { data: posts } = ([__temp, __restore] = vueExports.withAsyncContext(() => useAsyncData(
      "blogs",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UPageHero = _sfc_main$9;
          ...
          default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UPageSection, { ui: {
                ...
                default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UBlogPosts, { orientation: "vertical" }, {
                      default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<!--[-->`);
                          serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(posts), (post, index) => {
                            _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_Motion, {
                              key: index,
                              ...
                              default: vueExports.withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_UBlogPost, vueExports.mergeProps({
                                    variant: "naked",
                                    orientation: "horizontal",
                                    to: post.path
                                  }, { ref_for: true }, post, {
                                  ...
                                  return [
                                    vueExports.createVNode(_component_UBlogPost, vueExports.mergeProps({
                                      variant: "naked",
                                      orientation: "horizontal",
                                      to: post.path
                                    }, { ref_for: true }, post, {
                          ...
                          return [
                            (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(posts), (post, index) => {
                    ...
                    return [
                      vueExports.createVNode(_component_UBlogPosts, { orientation: "vertical" }, {
                        default: vueExports.withCtx(() => [
                          (vueExports.openBlock(true), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(posts), (post, index) => {
                            return vueExports.openBlock(), vueExports.createBlock(_component_Motion, {
                              key: index,
...
//# sourceMappingURL=index-DojUSwmx.js.map
