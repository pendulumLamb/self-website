import { aG as vueExports, af as useComponentProps, a9 as useAppConfig, ak as useFieldGroup, ae as useComponentIcons, a6 as tv, a2 as serverRenderer_cjs_prodExports, b as Primitive, f as _sfc_main$1, g as _sfc_main$2 } from "../server.mjs";
const theme = {
  "slots": {
          ...
          if (_push2) {
            ...
            return [
              vueExports.renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                vueExports.unref(isLeading) && vueExports.unref(leadingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$1, {
                  key: 0,
                  name: vueExports.unref(leadingIconName),
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: vueExports.unref(props).ui?.leadingIcon })
                }, null, 8, ["name", "class"])) : !!vueExports.unref(props).avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$2, vueExports.mergeProps({
                  key: 1,
                  size: vueExports.unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                }, vueExports.unref(props).avatar, {
                  "data-slot": "leadingAvatar",
              ...
              vueExports.renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                vueExports.unref(isTrailing) && vueExports.unref(trailingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$1, {
                  key: 0,
                  name: vueExports.unref(trailingIconName),
                  "data-slot": "trailingIcon",
                  class: ui.value.trailingIcon({ class: vueExports.unref(props).ui?.trailingIcon })
...
//# sourceMappingURL=Badge-CG2j_j__.js.map
