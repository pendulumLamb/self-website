import { aG as vueExports, af as useComponentProps, a9 as useAppConfig, an as useForwardProps, Y as reactivePick, a6 as tv, a2 as serverRenderer_cjs_prodExports, z as get, f as _sfc_main$2, g as _sfc_main$3, a4 as transformUI } from "../server.mjs";
import { c as TabsRoot_default, b as TabsList_default, a as TabsIndicator_default, d as TabsTrigger_default, T as TabsContent_default } from "./TabsTrigger-g0Bo3i_2.js";
import { _ as _sfc_main$4 } from "./Badge-CG2j_j__.js";
...
import "three";
import "./RovingFocusItem-DJ50BgZO.js";
import "./useId-BKH5UapV.js";
import "./utils-Ba_U-1sR.js";
import "./useDirection-CLi2Qful.js";
const theme$1 = {
  "slots": {
                      ...
                      default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "leading", {
                            ...
                            if (item.icon) {
                              _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$2, {
                                name: item.icon,
                                "data-slot": "leadingIcon",
                                class: ui.value.leadingIcon({ class: [vueExports.unref(props).ui?.leadingIcon, item.ui?.leadingIcon] })
                              }, null, _parent4, _scopeId3));
                            } else if (item.avatar) {
                              _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$3, vueExports.mergeProps({
                          ...
                          serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "trailing", {
                            ...
                            if (item.badge || item.badge === 0) {
                              _push4(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$4, vueExports.mergeProps({
                                color: "neutral",
                                variant: "outline",
                          ...
                          return [
                            vueExports.renderSlot(_ctx.$slots, "leading", {
                              ...
                              item.icon ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$2, {
                                key: 0,
                                name: item.icon,
                                "data-slot": "leadingIcon",
                                class: ui.value.leadingIcon({ class: [vueExports.unref(props).ui?.leadingIcon, item.ui?.leadingIcon] })
                              }, null, 8, ["name", "class"])) : item.avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$3, vueExports.mergeProps({
                                key: 1,
                                size: item.ui?.leadingAvatarSize || vueExports.unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                              }, { ref_for: true }, item.avatar, {
                                "data-slot": "leadingAvatar",
                            ...
                            vueExports.renderSlot(_ctx.$slots, "trailing", {
                              ...
                              item.badge || item.badge === 0 ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$4, vueExports.mergeProps({
                                key: 0,
                                color: "neutral",
                                variant: "outline",
                                size: item.ui?.trailingBadgeSize || vueExports.unref(props).ui?.trailingBadgeSize || ui.value.trailingBadgeSize()
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/Tabs.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vueExports.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.2_@internation_2988d20f1d04015da4287d1c836ac56e/node_modules/@nuxt/ui/dist/runtime/components/prose/Tabs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=Tabs-BqJ176B5.js.map
