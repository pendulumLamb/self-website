...
const props = defineProps({
  gridSize: { type: Number, required: false, default: 7 },
  pixelColor: { type: String, required: false, default: "currentColor" },
  animationStepDuration: { type: Number, required: false, default: 0.3 },
  className: { type: String, required: false, default: "" },
  style: { type: Object, required: false, default: () => ({}) },
  aspectRatio: { type: String, required: false, default: "100%" }
});
...
const isTouchDevice = typeof window !== "undefined" && ("ontouchstart" in window || navigator && navigator.maxTouchPoints > 0 || window.matchMedia && window.matchMedia("(pointer: coarse)").matches);
...
async function animatePixels(activate) {
...
<style scoped>
.pixelated-image-card__pixel{@apply transition-none}
</style>
