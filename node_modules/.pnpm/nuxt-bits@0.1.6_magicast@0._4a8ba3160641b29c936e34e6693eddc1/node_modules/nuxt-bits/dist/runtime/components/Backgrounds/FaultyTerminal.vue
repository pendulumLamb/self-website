...
const props = defineProps({
  ...
  gridMul: { type: Array, required: false, default: () => [2, 1] },
  digitSize: { type: Number, required: false, default: 1.5 },
  timeScale: { type: Number, required: false, default: 0.3 },
  pause: { type: Boolean, required: false, default: false },
  scanlineIntensity: { type: Number, required: false, default: 0.3 },
  glitchAmount: { type: Number, required: false, default: 1 },
  flickerAmount: { type: Number, required: false, default: 1 },
  noiseAmp: { type: Number, required: false, default: 1 },
  chromaticAberration: { type: Number, required: false, default: 0 },
  dither: { type: [Number, Boolean], required: false, default: 0 },
  curvature: { type: Number, required: false, default: 0.2 },
  tint: { type: String, required: false, default: "#ffffff" },
  mouseReact: { type: Boolean, required: false, default: true },
  mouseStrength: { type: Number, required: false, default: 0.2 },
  dpr: { type: Number, required: false, default: Math.min(1, 2) },
  pageLoadAnimation: { type: Boolean, required: false, default: true },
...
const setup = () => {
  ...
  const update = (t) => {
    ...
    if (!props.pause) {
      const elapsed = (t * 1e-3 + timeOffsetRef.value) * props.timeScale;
