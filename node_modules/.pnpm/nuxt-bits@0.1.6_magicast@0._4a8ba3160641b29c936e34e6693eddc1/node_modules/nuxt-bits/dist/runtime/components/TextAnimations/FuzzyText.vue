...
const props = defineProps({
  ...
  fontSize: { type: [Number, String], required: false, default: "clamp(2rem, 8vw, 8rem)" },
  fontWeight: { type: [String, Number], required: false, default: 900 },
  fontFamily: { type: String, required: false, default: "inherit" },
  color: { type: String, required: false, default: "#000" },
  enableHover: { type: Boolean, required: false, default: true },
  baseIntensity: { type: Number, required: false, default: 0.18 },
  hoverIntensity: { type: Number, required: false, default: 0.5 }
});
