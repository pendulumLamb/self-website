...
const props = defineProps({
  sparkColor: { type: String, required: false, default: "#fff" },
  sparkSize: { type: Number, required: false, default: 10 },
  sparkRadius: { type: Number, required: false, default: 15 },
  sparkCount: { type: Number, required: false, default: 8 },
  duration: { type: Number, required: false, default: 400 },
  easing: { type: String, required: false, default: "ease-out" },
  extraScale: { type: Number, required: false, default: 1 }
});
