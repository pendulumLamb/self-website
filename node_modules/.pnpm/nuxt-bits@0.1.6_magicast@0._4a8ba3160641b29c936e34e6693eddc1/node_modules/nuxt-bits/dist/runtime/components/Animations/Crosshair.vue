...
const lineHorizontalRef = useTemplateRef("lineHorizontalRef");
const lineVerticalRef = useTemplateRef("lineVerticalRef");
const filterXRef = useTemplateRef("filterXRef");
const filterYRef = useTemplateRef("filterYRef");
  ...
  watchEffect(() => {
    ...
    const handleMouseMove = (ev) => {
      ...
      if (props.containerRef) {
        ...
        if (mouseEvent.clientX < bounds.left || mouseEvent.clientX > bounds.right || mouseEvent.clientY < bounds.top || mouseEvent.clientY > bounds.bottom) {
