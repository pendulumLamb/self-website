...
const props = defineProps({
  color: { type: String, required: false, default: "#5227FF" },
...
const folderStyle = computed(() => ({
  transform: open.value ? "translateY(-8px)" : void 0
}));
...
const getPaperClasses = (index) => {
  ...
  return `absolute z-20 bottom-[10%] left-1/2 transition-all duration-300 ease-in-out overflow-hidden ${!open.value ? "transform -translate-x-1/2 translate-y-[10%] group-hover:translate-y-0" : "hover:scale-110"} ${sizeClasses}`.trim();
};
