...
const props = defineProps({
  ...
  waveSpeedX: { type: Number, required: false, default: 0.0125 },
  waveSpeedY: { type: Number, required: false, default: 5e-3 },
  waveAmpX: { type: Number, required: false, default: 32 },
  waveAmpY: { type: Number, required: false, default: 16 },
  xGap: { type: Number, required: false, default: 10 },
  yGap: { type: Number, required: false, default: 32 },
  friction: { type: Number, required: false, default: 0.925 },
  tension: { type: Number, required: false, default: 5e-3 },
  maxCursorMove: { type: Number, required: false, default: 100 },
...
const movePoints = (time) => {
  ...
  lines.forEach((pts) => {
    pts.forEach((p) => {
      const move = noise.perlin2((p.x + time * waveSpeedX) * 2e-3, (p.y + time * waveSpeedY) * 15e-4) * 12;
