...
const props = defineProps({
  waveSpeed: { type: Number, required: false, default: 0.05 },
  waveFrequency: { type: Number, required: false, default: 3 },
  waveAmplitude: { type: Number, required: false, default: 0.3 },
  waveColor: { type: Array, required: false, default: () => [0.5, 0.5, 0.5] },
  colorNum: { type: Number, required: false, default: 4 },
  pixelSize: { type: Number, required: false, default: 2 },
  ...
  mouseRadius: { type: Number, required: false, default: 1 }
});
...
const update = (t) => {
  ...
  if (!props.disableAnimation) {
    program.uniforms.time.value = t * 1e-3;
  }
