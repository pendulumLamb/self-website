...
const props = defineProps({
  beamWidth: { type: Number, required: false, default: 2 },
  beamHeight: { type: Number, required: false, default: 15 },
  beamNumber: { type: Number, required: false, default: 12 },
  lightColor: { type: String, required: false, default: "#ffffff" },
  speed: { type: Number, required: false, default: 2 },
  noiseIntensity: { type: Number, required: false, default: 1.75 },
  scale: { type: Number, required: false, default: 0.2 },
...
const initThreeJS = () => {
  ...
  camera = new THREE.PerspectiveCamera(30, 1, 0.1, 1e3);
  ...
  shadowCamera.far = 64;
  directionalLight.shadow.bias = -4e-3;
