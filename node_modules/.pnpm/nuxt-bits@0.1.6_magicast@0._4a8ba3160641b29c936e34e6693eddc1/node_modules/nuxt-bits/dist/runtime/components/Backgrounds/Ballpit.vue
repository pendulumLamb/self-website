...
const props = defineProps({
  ...
  followCursor: { type: Boolean, required: false, default: true },
  count: { type: Number, required: false, default: 200 },
  colors: { type: Array, required: false, default: () => [0, 0, 0] },
  ambientColor: { type: Number, required: false, default: 16777215 },
  ambientIntensity: { type: Number, required: false, default: 1 },
  lightIntensity: { type: Number, required: false, default: 200 },
  materialParams: { type: Object, required: false, default: () => ({
    metalness: 0.5,
    roughness: 0.5,
    clearcoat: 1,
    clearcoatRoughness: 0.15
  }) },
  minSize: { type: Number, required: false, default: 0.5 },
  maxSize: { type: Number, required: false, default: 1 },
  size0: { type: Number, required: false, default: 1 },
  gravity: { type: Number, required: false, default: 0.5 },
  friction: { type: Number, required: false, default: 0.9975 },
  wallBounce: { type: Number, required: false, default: 0.95 },
  maxVelocity: { type: Number, required: false, default: 0.15 },
  maxX: { type: Number, required: false, default: 5 },
  maxY: { type: Number, required: false, default: 5 },
  maxZ: { type: Number, required: false, default: 2 },
  controlSphere0: { type: Boolean, required: false, default: false }
});
gsap.registerPlugin(Observer);
const canvasRef = ref(null);
const spheresInstanceRef = ref(null);
class X {
  #config;
  #postprocessing = null;
  #resizeObserver;
