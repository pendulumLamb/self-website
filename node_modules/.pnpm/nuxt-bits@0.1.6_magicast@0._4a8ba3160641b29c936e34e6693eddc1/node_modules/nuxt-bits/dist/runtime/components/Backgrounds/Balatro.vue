...
const props = defineProps({
  spinRotation: { type: Number, required: false, default: -2 },
  spinSpeed: { type: Number, required: false, default: 7 },
  offset: { type: Array, required: false, default: () => [0, 0] },
  color1: { type: String, required: false, default: "#DE443B" },
  color2: { type: String, required: false, default: "#006BB4" },
  color3: { type: String, required: false, default: "#162325" },
  contrast: { type: Number, required: false, default: 3.5 },
  lighting: { type: Number, required: false, default: 0.4 },
  spinAmount: { type: Number, required: false, default: 0.25 },
  pixelFilter: { type: Number, required: true, default: 745 },
  spinEase: { type: Number, required: false, default: 1 },
  isRotate: { type: Boolean, required: true, default: false },
  mouseInteraction: { type: Boolean, required: true, default: true },
