...
const props = defineProps({
  particleCount: { type: Number, required: false, default: 200 },
  particleSpread: { type: Number, required: false, default: 10 },
  speed: { type: Number, required: false, default: 0.1 },
  particleColors: { type: Array, required: false, default: () => ["#ffffff"] },
  moveParticlesOnHover: { type: Boolean, required: false, default: false },
  particleHoverFactor: { type: Number, required: false, default: 1 },
  alphaParticles: { type: Boolean, required: false, default: false },
  particleBaseSize: { type: Number, required: false, default: 100 },
  sizeRandomness: { type: Number, required: false, default: 1 },
  cameraDistance: { type: Number, required: false, default: 20 },
  disableRotation: { type: Boolean, required: false, default: false },
...
<style scoped>
:deep(canvas),div{@apply !absolute !top-0 !left-0 !size-full}
</style>
