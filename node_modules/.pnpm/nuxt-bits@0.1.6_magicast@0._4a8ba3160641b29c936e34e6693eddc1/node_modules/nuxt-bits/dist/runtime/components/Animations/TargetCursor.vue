...
const props = defineProps({
  targetSelector: { type: String, required: false, default: ".cursor-target" },
  spinDuration: { type: Number, required: false, default: 2 },
  hideDefaultCursor: { type: Boolean, required: false, default: true }
});
