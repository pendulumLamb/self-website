...
const props = defineProps({
  ...
  cardDistance: { type: Number, required: false, default: 60 },
  verticalDistance: { type: Number, required: false, default: 70 },
  delay: { type: Number, required: false, default: 5e3 },
  pauseOnHover: { type: Boolean, required: false, default: false },
  onCardClick: { type: Function, required: false },
  skewAmount: { type: Number, required: false, default: 6 },
  easing: { type: String, required: false, default: "elastic" }
});
