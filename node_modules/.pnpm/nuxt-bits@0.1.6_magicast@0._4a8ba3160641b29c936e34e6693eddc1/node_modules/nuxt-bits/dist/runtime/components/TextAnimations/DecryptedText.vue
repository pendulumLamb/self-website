...
const props = defineProps({
  ...
  maxIterations: { type: Number, required: false, default: 10 },
  sequential: { type: Boolean, required: false, default: false },
  revealDirection: { type: String, required: false, default: "start" },
  useOriginalCharsOnly: { type: Boolean, required: false, default: false },
  characters: { type: String, required: false, default: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+" },
  className: { type: String, required: false, default: "" },
  encryptedClassName: { type: String, required: false, default: "" },
  parentClassName: { type: String, required: false, default: "" },
  animateOn: { type: String, required: false, default: "hover" }
});
...
const revealedIndices = ref(/* @__PURE__ */ new Set());
...
watch(
  ...
  () => {
    ...
    const availableChars = props.useOriginalCharsOnly ? Array.from(new Set(props.text.split(""))).filter((char) => char !== " ") : props.characters.split("");
    ...
    if (isHovering.value) {
      ...
      displayText.value = props.text;
      revealedIndices.value = /* @__PURE__ */ new Set();
      isScrambling.value = false;
    }
  }
);
