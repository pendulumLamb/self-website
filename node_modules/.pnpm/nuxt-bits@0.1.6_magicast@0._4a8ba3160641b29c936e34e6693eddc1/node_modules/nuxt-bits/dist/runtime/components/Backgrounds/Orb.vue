...
const props = defineProps({
  ...
  hoverIntensity: { type: Number, required: false, default: 0.2 },
  rotateOnHover: { type: Boolean, required: false, default: true },
  forceHoverState: { type: Boolean, required: false, default: false }
});
