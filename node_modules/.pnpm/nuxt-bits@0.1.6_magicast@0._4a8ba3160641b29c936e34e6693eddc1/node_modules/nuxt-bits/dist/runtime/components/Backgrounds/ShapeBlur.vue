...
const props = defineProps({
  ...
  variation: { type: Number, required: false, default: 0 },
  pixelRatioProp: { type: Number, required: false, default: 2 },
  shapeSize: { type: Number, required: false, default: 1.2 },
  roundness: { type: Number, required: false, default: 0.4 },
  borderSize: { type: Number, required: false, default: 0.05 },
  circleSize: { type: Number, required: false, default: 0.3 },
  circleEdge: { type: Number, required: false, default: 0.5 }
});
const shapeBlurContainer = ref();
...
<style scoped>
.shape-blur-container{@apply size-full relative overflow-hidden}.shape-blur-container :deep(canvas){@apply !size-full block}
</style>
