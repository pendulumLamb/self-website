...
const props = defineProps({
  SIM_RESOLUTION: { type: Number, required: false, default: 128 },
  DYE_RESOLUTION: { type: Number, required: false, default: 1440 },
  CAPTURE_RESOLUTION: { type: Number, required: false, default: 512 },
  DENSITY_DISSIPATION: { type: Number, required: false, default: 3.5 },
  VELOCITY_DISSIPATION: { type: Number, required: false, default: 2 },
  PRESSURE: { type: Number, required: false, default: 0.1 },
  PRESSURE_ITERATIONS: { type: Number, required: false, default: 20 },
  CURL: { type: Number, required: false, default: 3 },
  SPLAT_RADIUS: { type: Number, required: false, default: 0.2 },
  SPLAT_FORCE: { type: Number, required: false, default: 6e3 },
  SHADING: { type: Boolean, required: false, default: true },
  COLOR_UPDATE_SPEED: { type: Number, required: false, default: 10 },
  BACK_COLOR: { type: Object, required: false, default: () => ({ r: 0.5, g: 0, b: 0 }) },
...
onMounted(() => {
  ...
  function getWebGLContext(canvasEl) {
    ...
    let gl2 = canvasEl.getContext("webgl2", params);
    if (!gl2) {
      gl2 = canvasEl.getContext("webgl", params) || canvasEl.getContext("experimental-webgl", params);
    }
    if (!gl2) {
