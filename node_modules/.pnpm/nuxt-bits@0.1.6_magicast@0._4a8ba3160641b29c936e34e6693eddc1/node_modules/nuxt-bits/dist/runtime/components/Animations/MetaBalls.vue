...
const props = defineProps({
  color: { type: String, required: false, default: "#27FF64" },
  speed: { type: Number, required: false, default: 0.3 },
  enableMouseInteraction: { type: Boolean, required: false, default: true },
  hoverSmoothness: { type: Number, required: false, default: 0.05 },
  animationSize: { type: Number, required: false, default: 30 },
  ballCount: { type: Number, required: false, default: 15 },
  clumpFactor: { type: Number, required: false, default: 1 },
  cursorBallSize: { type: Number, required: false, default: 3 },
  cursorBallColor: { type: String, required: false, default: "#27FF64" },
  enableTransparency: { type: Boolean, required: false, default: false },
  mixBlendMode: { type: String, required: false, default: "normal" }
});
