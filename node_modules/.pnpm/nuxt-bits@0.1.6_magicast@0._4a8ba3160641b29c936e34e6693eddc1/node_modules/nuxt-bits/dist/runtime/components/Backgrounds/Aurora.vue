...
const props = defineProps({
  colorStops: { type: Array, required: false, default: () => ["#7cff67", "#171D22", "#7cff67"] },
  amplitude: { type: Number, required: false, default: 1 },
  blend: { type: Number, required: false, default: 0.5 },
  time: { type: Number, required: false },
  speed: { type: Number, required: false, default: 1 },
  intensity: { type: Number, required: false, default: 1 },
