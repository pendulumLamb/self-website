...
const props = defineProps({
  ...
  radius: { type: Number, required: false, default: 300 },
  damping: { type: Number, required: false, default: 0.45 },
  fadeOut: { type: Number, required: false, default: 0.6 },
  ease: { type: String, required: false, default: "power3.out" }
});
const rootRef = useTemplateRef("rootRef");
const fadeRef = useTemplateRef("fadeRef");
const setX = shallowRef();
const setY = shallowRef();
