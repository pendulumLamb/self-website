...
const props = defineProps({
  focal: { type: Array, required: false, default: () => [0.5, 0.5] },
  rotation: { type: Array, required: false, default: () => [1, 0] },
  starSpeed: { type: Number, required: false, default: 0.5 },
  density: { type: Number, required: false, default: 1 },
  hueShift: { type: Number, required: false, default: 140 },
  disableAnimation: { type: Boolean, required: false, default: false },
  speed: { type: Number, required: false, default: 1 },
  mouseInteraction: { type: Boolean, required: false, default: true },
  glowIntensity: { type: Number, required: false, default: 0.3 },
  saturation: { type: Number, required: false, default: 0 },
  mouseRepulsion: { type: Boolean, required: false, default: true },
  twinkleIntensity: { type: Number, required: false, default: 0.3 },
  rotationSpeed: { type: Number, required: false, default: 0.1 },
  repulsionStrength: { type: Number, required: false, default: 2 },
  autoCenterRepulsion: { type: Number, required: false, default: 0 },
...
const setup = () => {
  ...
  function update(t) {
    ...
    if (!props.disableAnimation) {
      ...
      program.uniforms.uStarSpeed.value = t * 1e-3 * props.starSpeed / 10;
    }
