...
const props = defineProps({
  hueShift: { type: Number, required: false, default: 0 },
  noiseIntensity: { type: Number, required: false, default: 0 },
  scanlineIntensity: { type: Number, required: false, default: 0 },
  speed: { type: Number, required: false, default: 0.5 },
  scanlineFrequency: { type: Number, required: false, default: 0 },
  warpAmount: { type: Number, required: false, default: 0 },
  resolutionScale: { type: Number, required: false, default: 1 }
});
...
const loop = () => {
  ...
  program.uniforms.uTime.value = (performance.now() - start) / 1e3 * props.speed;
