...
const props = defineProps({
  speed: { type: Number, required: false, default: 5 },
  scale: { type: Number, required: false, default: 1 },
  color: { type: String, required: false, default: "#7B7481" },
  noiseIntensity: { type: Number, required: false, default: 1.5 },
...
const initSilk = () => {
  ...
  const update = (t) => {
    ...
    const deltaTime = (t - lastTime) / 1e3;
    lastTime = t;
...
<style scoped>
:deep(canvas),div{@apply !absolute !top-0 !left-0 !size-full}:deep(canvas){@apply !object-cover}
</style>
