...
const props = defineProps({
  ...
  bend: { type: Number, required: false, default: 3 },
  textColor: { type: String, required: false, default: "#ffffff" },
  borderRadius: { type: Number, required: false, default: 0.05 },
  font: { type: String, required: false, default: "bold 30px Figtree" },
  scrollSpeed: { type: Number, required: false, default: 2 },
  scrollEase: { type: Number, required: false, default: 0.05 }
});
