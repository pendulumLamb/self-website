...
import * as _vueuse_shared3 from "@vueuse/shared";
...
declare function useBodyScrollLock(initialState?: boolean | undefined): vue1.WritableComputedRef<boolean, boolean>;
...
declare function useComposing(onEnd?: (event: CompositionEvent) => void): {
  isComposing: vue1.Ref<boolean, boolean>;
 ...
 */
declare function useDirection(dir?: Ref<Direction | undefined>): vue1.ComputedRef<Direction>;
...
declare function useFormControl(el: MaybeElementRef): vue1.ComputedRef<boolean>;
...
declare function useForwardExpose<T extends ComponentPublicInstance>(): {
  ...
  currentRef: vue1.Ref<Element | T | null | undefined, Element | T | null | undefined>;
  currentElement: vue1.ComputedRef<HTMLElement>;
};
 ...
 */
declare function useForwardProps<T extends Record<string, any>>(props: MaybeRefOrGetter<T>): vue1.ComputedRef<WithOptionalBooleans<T>>;
//#endregion
 ...
 */
declare function useForwardPropsEmits<T extends Record<string, any>, Name extends string>(props: MaybeRefOrGetter<T>, emit?: (name: Name, ...args: any[]) => void): vue1.ComputedRef<{ [K in keyof T as [T[K]] extends [boolean] ? K : never]?: T[K] | undefined } & { [K_1 in keyof T as [T[K_1]] extends [boolean] ? never : K_1]: T[K_1] } & Record<string, any>>;
...
declare function useGraceArea(triggerElement: Ref<HTMLElement | undefined>, containerElement: Ref<HTMLElement | undefined>): {
  isPointerInTransit: _vueuse_shared3.RefAutoResetReturn<boolean>;
  onPointerExit: _vueuse_shared3.EventHookOn<void>;
};
 ...
 */
declare function useLocale(locale?: Ref<string | undefined>): vue1.ComputedRef<string>;
...
declare function useSize(element: MaybeElementRef): {
  width: vue1.ComputedRef<number>;
  height: vue1.ComputedRef<number>;
};
...
declare function useTypeahead(callback?: (search: string) => void): {
  search: _vueuse_shared3.RefAutoResetReturn<string>;
