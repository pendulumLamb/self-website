...
var DateFieldInput_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		const { handleSegmentClick, handleSegmentKeydown, handleSegmentBeforeInput, handleSegmentCompositionStart, handleSegmentCompositionEnd, attributes } = require_date_useDateField.useDateField({
			hasLeftFocus,
			lastKeyZero,
		...
		return (_ctx, _cache) => {
			return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({
				...
				beforeinput: (0, vue.unref)(handleSegmentBeforeInput),
				compositionstart: (0, vue.unref)(handleSegmentCompositionStart),
				compositionend: (0, vue.unref)(handleSegmentCompositionEnd),
				focusout: () => {
